        ...
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="space-y-4">
              <h3 className="text-2xl font-bold bg-gradient-to-r from-blue-500 to-purple-500 bg-clip-text text-transparent">E-Shop</h3>
              <p className="text-gray-400">Your one-stop gaming shop with the latest and greatest in gaming gear.</p>
            ...
            <div>
              ...
              <form className="flex">
                ...
                <button
                  type="submit"
                  className="bg-blue-500 px-4 py-2 rounded-r hover:bg-blue-600 transition-colors"
                >
                  Subscribe
                </button>
              </form>
